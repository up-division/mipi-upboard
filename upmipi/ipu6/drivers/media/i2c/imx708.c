...
#ifdef CONFIG_ACPI
static const struct acpi_device_id imx708_acpi_ids[] = {
	{ "IMX708", 0 },
	{}
};
MODULE_DEVICE_TABLE(acpi, imx708_acpi_ids);
#else
...
static struct i2c_driver imx708_i2c_driver = {
	.driver = {
		.name = "imx708",
#ifdef CONFIG_ACPI
		.acpi_match_table = ACPI_PTR(imx708_acpi_ids),
#else
