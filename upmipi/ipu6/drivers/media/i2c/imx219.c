...
#ifdef CONFIG_ACPI
static const struct acpi_device_id imx219_acpi_ids[] = {
	{ "IMX219", 0 },
	{}
};
MODULE_DEVICE_TABLE(acpi, imx219_acpi_ids);
#else
...
static struct i2c_driver imx219_i2c_driver = {
	.driver = {
		.name = "imx219",
#ifdef CONFIG_ACPI
		.acpi_match_table = ACPI_PTR(imx219_acpi_ids),
#else
