...
static const struct ipu_sensor_config ipu_supported_sensors[] = {
	...
	/* IMX219 */
	IPU_SENSOR_CONFIG("IMX219", 4, 456000000, 364000000),
	/* IMX477 */
	IPU_SENSOR_CONFIG("IMX477", 3, 450000000, 453000000, 456000000),
	/* IMX708 */
	IPU_SENSOR_CONFIG("IMX708", 3, 450000000, 447000000, 453000000),
	/* OV5647 */
	// IPU_SENSOR_CONFIG("OV5647", 2, 218500000, 208333000),
	IPU_SENSOR_CONFIG("OV5647", 2, 218750000, 204166750, 204166750, 137500000),
	/* GalaxyCore GC0310 */
